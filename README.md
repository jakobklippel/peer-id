...
- No fees. The service is designed to be free for users and make it accessible and usefull for all. We believe that identity services such as PeerID should be a pubic good, cost free and funded entirely by donations. The lack of a financial incentive system likely will cause a slower initial adoption. Financial incentives however, can create conflicts and distract from the mission and purpose of the solution and should be avoided.
